...
2. **`design-system.md`** — application UX, interaction, visual tokens, responsive/motion/accessibility system.
3. **`event-renderer-system.md`** — generated guest-site renderer architecture.
4. **`e2e-workflow.md`** — canonical journey reference.
5. **`screen-spec.md`** — screen/surface-level behavior.
6. **`CHANGELOG-v5.md`** — summary of the decisions reconciled into this revision.
7. **`prototypes/creation-flow.html`** — behavioral prototype; not architectural truth.
8. **`renderer-tests/`** — renderer evidence/test artifacts; not product requirements.
